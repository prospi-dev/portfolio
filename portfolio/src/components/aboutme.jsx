...
const AboutMe = () => (
  <>
    <section id="about" className="flex flex-col items-center justify-center px-4 py-8 text-center lg:flex-row lg:gap-10 scroll-mt-20">
      <motion.div className="flex flex-col items-center justify-center px-4 py-8 text-center lg:flex-row lg:gap-10" initial={{ opacity: 0, y: 40 }}
